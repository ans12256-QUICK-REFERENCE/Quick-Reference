...
* [Above syntax to link to section below](https://stackoverflow.com/questions/2822089/how-to-link-to-part-of-the-same-document-in-markdown- [Table of Contents](#table-of-contents)
  - [Relevant Links](#relevant-links)
- [Things that drive you NUTS !!!](#things-that-drive-you-nuts-)
  - [Environments](#environments)
    - [Activate my_environment:](#activate-my_environment)
...
- [`matplotlib.pyplot` visualizations](#matplotlibpyplot-visualizations)
  ...
  - [Single letter legend](#single-letter-legend)
  - [Font Sizes](#font-sizes)
- [Derivations](#derivations)): Note: just one # for all heading sizes, no space between # and anchor name, anchor tag names must be lowercase, and delimited by dashes if multi-word.
